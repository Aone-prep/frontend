...
const AddMockTestForm = ({ onAdd, onCancel }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    onAdd({ name, description, duration, maxScore });
  };

  return (
    <form onSubmit={handleSubmit}>
      <h3 className="text-xl font-bold mb-4">Add Mock Test</h3>
      <div className="mb-4">
      ...
      <button
        ...
        onClick={onCancel} // Calls the onCancel function passed as prop
