...
const CourseContentForm = ({ content, onClose }) => {
  ...
  // Fetch courses and populate the form if editing an existing course content
  useEffect(() => {
    const fetchData = async () => {
      try {
        const coursesData = await fetchCourses(); // Fetch courses for dropdown
        setCourses(coursesData);

        if (content) {
          // If content is passed (editing), set it to form state
  ...
  // Handle editor changes for text content
